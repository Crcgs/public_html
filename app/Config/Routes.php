...
$routes->get('latest-news', 'HomeController::latestNews');
$routes->get('knowledge-articles', 'HomeController::knowledgeArticles');
$routes->get('research-paper', 'HomeController::researchPaper');
$routes->get('opinion-insights', 'HomeController::opinionInsights');
$routes->get('glossary', 'HomeController::glossary');
