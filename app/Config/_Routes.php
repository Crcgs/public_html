...
$routes->get('author/(:segment)', 'AuthorController::index/$1');
...
$routes->get('about-us', 'HomeController::page');
$routes->get('our-mission', 'HomeController::page');
$routes->get('our-vision', 'HomeController::page');
$routes->get('our-author', 'HomeController::page');
 ...
 * --------------------------------------------------------------------
 */
$routes->get('glossary-detail/(:num)', 'HomeController::glossaryDetail/$1');
...
$routes->get($customRoutes->admin .'/add-plan', 'PlanController::create');
$routes->post($customRoutes->admin .'/store', 'PlanController::store');
$routes->get($customRoutes->admin .'/edit-plan/(:num)', 'PlanController::edit/$1');
$routes->post($customRoutes->admin .'/update/(:num)', 'PlanController::update/$1');
$routes->get($customRoutes->admin .'/delete/(:num)', 'PlanController::delete/$1');
$routes->post($customRoutes->admin .'/toggle-status/(:num)', 'PlanController::toggleStatus/$1');
    ...
    foreach ($languages as $language) {
        ...
        if ($generalSettings->site_lang != $language->id) {
            ...
            $routes->get($language->short_form, 'HomeController::index');
             ...
             $routes->get($key . 'author/(:segment)', 'AuthorController::index/$1');
