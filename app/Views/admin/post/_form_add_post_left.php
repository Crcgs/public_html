            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="latest_news" value="1" class="square-purple" <?= old('latest_news') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>
        <?php else: ?>
        ...
        if (checkUserPermission('manage_all_posts')): ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="knowledge_articles" value="1" class="square-purple" <?= old('knowledge_articles') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>  
             ...
             <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="research_paper" value="1" class="square-purple" <?= old('research_paper') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>  
             ...
             <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="opinion_insights" value="1" class="square-purple" <?= old('opinion_insights') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>    
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="glossary" value="1" class="square-purple" <?= old('glossary') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>  
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="checkbox" name="notifications_events" value="1" class="square-purple" <?= old('notifications_events') == 1 ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>  
        <?php else: ?>
