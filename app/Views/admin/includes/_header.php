...
<head>
    ...
    <style>
        /* When sidebar is expanded - show big logo */
.logo .logo-mini {
    display: none;
}
.sidebar-expanded .logo .logo-lg {
    display: inline-block;
}

/* When sidebar is collapsed - hide big logo and show mini logo */
.sidebar-collapse .logo .logo-lg {
    display: none;
}
...
<div class="wrapper">
            ...
            <dv class="sidebar-scrollbar" style="display: block; height: 100%; min-height: 100%;">
                <ul class="sidebar-menu" data-widget="tree" style="padding-bottom: 160px;">
                    ...
                    if (checkUserPermission('admin')): ?>
                        <li class="nav-plans">
                            <a href="<?= adminUrl('plans'); ?>"><i class="fa fa-cubes" aria-hidden="true"></i><span>Plans</span></a>
                        </li>
                    <?php endif;
    ...
    <?php if(!empty($uriString)):
        echo '.nav-'.$uriString.' > a {color: #fff !important; background: #2B466A !important;}';
    else:
        echo '.nav-home > a {color: #fff !important; background: #2B466A !important;}';
    endif;?>
</style>
