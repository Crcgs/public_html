                ...
                <div class="box-body">
                    ...
                    if ($role->role != 'admin'): ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-1 col-sm-2 col-xs-2">
                                    <input type="checkbox" name="plans" value="1" id="role_plans" class="square-purple" <?= $role->plans == 1 ? 'checked' : ''; ?>>
                                </div>
                                <div class="col-md-11 col-sm-10 col-xs-10">
                                    <label for="role_plans" class="control-label cursor-pointer">Plans</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-1 col-sm-2 col-xs-2">
                                    <input type="checkbox" name="add_plan" value="1" id="role_add_plan" class="square-purple" <?= $role->add_plan == 1 ? 'checked' : ''; ?>>
                                </div>
                                <div class="col-md-11 col-sm-10 col-xs-10">
                                    <label for="role_add_plan" class="control-label cursor-pointer">Add Plan</label>
                                </div>
                            </div>
                        </div>
