            ...
            <form action="<?= base_url('AdminController/editUserPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="designation" placeholder="Designation" value="<?= esc($user->designation); ?>">
                    </div>


                    <div class="form-group">
                        <label>Department</label>
                        <input type="text" class="form-control form-input" name="department" placeholder="Department" value="<?= esc($user->department); ?>">
                    </div>


                    <div class="form-group">
                        <label>Company</label>
                        <input type="text" class="form-control form-input" name="company" placeholder="Company" value="<?= esc($user->company); ?>">
                    </div>

                    <div class="form-group">
                        <label>Location</label>
                        <input type="text" class="form-control form-input" name="location" placeholder="Location" value="<?= esc($user->location); ?>">
                    </div>
 

                    <div class="form-group">
                        <label class="control-label"><?= trans('about_me'); ?></label>
                        <textarea class="form-control text-area"  id="about_me"  name="about_me" placeholder="<?= trans('about_me'); ?>"><?= esc($user->about_me); ?></textarea>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateCounter() {
        ...
        // Trim extra words if over limit
        if (used > MAX_WORDS) {
