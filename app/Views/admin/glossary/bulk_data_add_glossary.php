...
<div class="row">
    <div class="col-sm-12 col-lg-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title"><?= trans('bulk_data_add_glossary'); ?></h3><br>
    ...
    <div class="col-sm-12 col-lg-4">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    <form action="<?= base_url('AdminController/downloadCSVFileGlossary'); ?>" method="post">
                        <?= csrf_field(); ?>
...
<script>
    $(function () {
        $('#drag-and-drop-zone').dmUploader({
            url: '<?= base_url("AdminController/generateCSVObjectGlossary"); ?>',
            multiple: false,
            extFilter: ["csv"],
    ...
    try {
        ...
        if (obj.result == 1) {
            ...
            $("#csv_uploaded_files").html(
                '<li class="list-group-item list-group-item-success">' +
                '<i class="fa fa-check"></i> ' + obj.message +
                '</li>'
            );
            ...
            $("#csv_uploaded_files").html(
                ...
                '<i class="fa fa-times"></i> ' + obj.message +
                '</li>'
            );
    ...
    //         $.ajax({
    //             type: "POST",
    //             url: VrConfig.baseURL + "/admin/import-csv-item",
