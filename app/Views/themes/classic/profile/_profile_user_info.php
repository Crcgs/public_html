<div class="row-custom">
    <div class="profile-details">
        ...
        <div class="right">
            <div class="row-custom">
                <h1 class="username" style="float: none;"><?= esc($user->username); ?></h1>
                <div class="designation-box">
                    ...
                    <?php } ?>
                     ...
                     <?php if(!empty($user->department)){ ?> 
                        <p><strong>Department:</strong> <?= esc($user->department); ?>t</p>
                    <?php } ?>
                    ...
                    <p><strong>Location:</strong> <?= esc($user->location); ?></p>
                   <?php } ?>
                </div>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, expedita reprehenderit. Ipsa, ab facere obcaecati vero molestias quae voluptate nulla reprehenderit libero deleniti vel! Corporis sint eos impedit! Autem, facere?</p>
            </div>
            <div class="row-custom">
                <p class="p-last-seen">
