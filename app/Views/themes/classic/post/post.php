...
// FIX BLANK PAGE – fallback variables
$baseCategories   = $baseCategories   ?? Globals::$categories;
$generalSettings  = $generalSettings  ?? Globals::$generalSettings;
$baseSettings     = $baseSettings     ?? Globals::$settings;
$darkMode         = $darkMode         ?? Globals::$darkMode;
?>
                ...
                <div class="post-content">
                    <p class="m-0">
                        ...
                        <?php if (authCheck() && user()->id == $post->user_id): ?>
                            <a href="<?= adminUrl('edit-post/' . $post->id); ?>" class="pull-right btn btn-xs btn-info btn-edit-post h-auto" style="padding: 3px 10px !important; height: auto !important;"><i class="icon-edit"></i><?= trans("edit"); ?></a>
                        <?php endif; ?>
                    </p>
                    ...
                    <div class="post-meta">
                        ...
                        <div class="post-details-meta-date">
                            <?php if ($generalSettings->show_post_date == 1): ?>
                                <span class="sp-left"><?= formatDateFront($post->created_at); ?>&nbsp;-&nbsp;</span>
                                <?php if (!empty($post->updated_at)): ?>
                                    <span class="sp-left sp-post-update-date"><?= trans("updated"); ?>:&nbsp;&nbsp;-&nbsp;<?= formatHour($post->updated_at); ?></span>
                                <?php endif;
                            endif; ?>
                        </div>
