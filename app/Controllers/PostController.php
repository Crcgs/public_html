...
class PostController extends BaseAdminController
{
    ...
    public function addPostPost()
    {
        ...
        if (!$this->validate(getValRules($val))) {
            ...
            if (!empty($postId)) {
                ...
                //save multiple subcategories mapping
                $this->postAdminModel->savePostCategoriesFromInput($postId);
                //add post files
    ...
    public function editPost($id)
    {
        ...
        $data['users'] = $authModel->getAdminOrAuthorActiveUsers();
        ...
        //fetch mapped subcategory ids for multi-select
        $data['postSubCategoryIds'] = $this->postAdminModel->getPostCategoryIds($id);
