                                ...
                                <div class="widget-body">
                                    <ul class="widget-follow">
                                        <?php foreach ($socialLinks as $socialLink): ?>
                                            <li><a class="<?= esc($socialLink['key']); ?>" href="<?= $socialLink['url']; ?>" target="_blank"><i class="<?= esc($socialLink['key']=='twitter')?'fa-brands fa-x-twitter':'icon-'.$socialLink['key']; ?>"></i><span><?= esc($socialLink['name']); ?></span></a></li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                            </div>
