<section class="inner-pages-banner" style="border-top: solid 1px #ddd;">
    <div class="inner-banner-item">
        <img src="<?= base_url('assets/new'); ?>/images/contact-us-banner-removebg-preview-2.png" alt="" class="w-100">
    </div>
</section>
<div id="wrapper">
    ...
    <div class="container m-b-30">
        <div class="row">
            ...
            <div id="content" class="col-sm-12 conatct-page-wrap">
                <div class="row">
                        ...
                        <div class="page-contact">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <form action="<?= base_url('contact-post'); ?>" method="post" id="form_validate" class="validate_terms row">
                                        <?= csrf_field(); ?>
                                        ...
                                        <div class="form-group text-center col-md-12">
                                            <button type="submit" class="btn btn-md btn-custom "><?= trans("btn_submit"); ?></button>
                                        </div>
                                    </form>
                                </div>
