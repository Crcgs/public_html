            ...
            <form action="<?= base_url('AdminController/editUserPost'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="designation" placeholder="Designation" value="">
                    </div>


                    <div class="form-group">
                        <label>Department</label>
                        <input type="text" class="form-control form-input" name="department" placeholder="Department" value="">
                    </div>


                    <div class="form-group">
                        <label>Company</label>
                        <input type="text" class="form-control form-input" name="company" placeholder="Company" value="">
                    </div>

                    <div class="form-group">
                        <label>Location</label>
                        <input type="text" class="form-control form-input" name="location" placeholder="Location" value="">
                    </div>
