            ...
            <form action="<?= base_url('AdminController/routeSettingsPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="plans_readonly" value="plans" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="plans" value="<?= $routes->plans; ?>" maxlength="100" required>
                            </div>
                        </div>
                    </div>
