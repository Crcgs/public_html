...
class PostModel extends BaseModel
{
    ...
    public function __construct()
    {
        ...
        $this->sliderPostsLimit = 5;
        $this->breakingPostsLimit = 5;
    ...
    public function getPostsByColum($colum,$val) {
        $this->buildQuery(null, true);
        return $this->builder->where($colum, $val)->get()->getResult();
    }
